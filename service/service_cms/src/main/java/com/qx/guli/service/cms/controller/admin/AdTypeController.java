package com.qx.guli.service.cms.controller.admin;


import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.qx.guli.common.base.result.R;
import com.qx.guli.service.cms.entity.AdType;
import com.qx.guli.service.cms.service.AdTypeService;
...
public class AdTypeController {
    ...
    public R listPage(@ApiParam(value = "当前页码", required = true) @PathVariable Long current,
        ...
        Page<AdType> pageParam = new Page<>(current, size);
