package com.qx.test.eduservice;
...
public class CodeGenerator {
    ...
    public void main1() {
        ...
        //设置BaseEntity
        strategy.setSuperEntityClass("com.qx.guli.service.base.model.BaseEntity");
        // 填写BaseEntity中的公共字段
    ...
    public void genCode() {
        ...
        pc.setParent("com.qx.guli.service");
        pc.setController("controller");
        pc.setEntity("entity");
        pc.setService("service");
        pc.setMapper("mapper");
        ...
        strategy.setTablePrefix(moduleName + "_");//设置表前缀不生成数据库表映射到实体的命名策略
    ...
    public void test(){
        ...
        O : for(;;){
            i++;
            for(;;) {
                if(i > j--){ // 只要 i < j ，就不能跳出内层循环，只有当 i > j 时，才会跳出循环
                    break O;
                }
            }
        }
